...
public class Forms 
{
	public static ArrayList <Student> students = getAllStudentsEnrolled();
	public static ArrayList <Course> courses;
	public static String filePath = "C:\\Users\\Rita\\Desktop\\HighSchool-Management-main\\form\\Students";
	...
	//Methods about Files
	public static ArrayList<Student> getAllStudentsEnrolled() {
	...
	public static void WriteInFile() {
		...
		try (ObjectOutputStream oos = new ObjectOutputStream(fos)) {
			oos.writeObject(getAllStudentsEnrolled());
			oos.close();
			fos.close();
		} catch(IOException e) {
			e.printStackTrace();
	...
	public static ArrayList<Course> InfoCourses(){
